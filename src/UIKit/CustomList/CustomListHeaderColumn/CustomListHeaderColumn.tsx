...
function CustomListHeaderColumn(props: ListColumnProps) {
	...
	const sortButton = (
		<div className="custom-list-header-column-uikit__button" onClick={toggleSortColumn}>
			<div className="custom-list-header-column-uikit__button_up">
				{isShowArrowUp() && icons.SortArrow}
			</div>
			<div className="custom-list-header-column-uikit__button_down">
	...
	return (
		<div className="custom-list-header-column-uikit" style={{ flex: fr }}>
			<div className="custom-list-header-column-uikit__name">
				{name}
			</div>
