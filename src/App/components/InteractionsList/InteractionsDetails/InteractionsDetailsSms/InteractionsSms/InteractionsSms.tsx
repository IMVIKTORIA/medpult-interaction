...
interface IInteractionsSmsProps {
  /** id Взаимодействия */
  interactionId: string;
  /** Данные комментария */
  interactionsSmsData: IInteractionsCallData;
    ...
    <div className="interactions-details_panel">
      <div className="interactions-details_panel__content">
        <div className="interactions-comment">
          ...
          <div className="interactions-sms__button_wrapper">
            {channelCode == InteractionsChannel.incomingSms && (
              <div
                onClick={handleReplyClick}
                className="interactions-sms__button"
              >
